...
function AITest(p) {
	...
	this.acceptTrade = function(tradeObj) {
		...
		tradeValue += 10 * tradeObj.getspecialstationJailCard();
		...
		if (tradeValue > 25) {
			...
			return new Trade(initiator, recipient, proposedMoney, property, tradeObj.getspecialstationJailCard(), tradeObj.getChanceJailCard());
		}
	...
	this.postBail = function() {
		...
		if ((p.specialstationJailCard || p.chanceJailCard) && p.jailroll === 2) {
			return true;
		} else {
			return false;
		}
